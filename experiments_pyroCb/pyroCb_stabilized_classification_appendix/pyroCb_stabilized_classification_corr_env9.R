...
save(wbce.per.env.sc,
     num.inv.sets,
     file = file.path(script_dir, "saved_data/pyroCb_stabilized_classification_corr_env9.rdata"))




# store the sessionInfo:
writeLines(capture.output(sessionInfo()), file.path(script_dir, "sessionInfo/pyroCb_stabilized_classification_corr_env9.txt"))
