# in this script, we run stabilized classification on the pyroCb dataset with 
# DeLong's test with continuous environment
...
# divide the data into 5 environments
envs <- env5
...
for(e in 1:length(levels(envs))){
  ...
  for(s in 1:length(inv.sets)){
    ...
    # extract data from current invariant subset
