...
for(b in 1:nreps){
  ...
  s <- generate.samples.semirandom(n = n, n.test = 1000, t = t, mod = "logreg")
...
for(b in 1:nreps){
  ...
  # generate data from the semirandom SCM
  s <- generate.samples.semirandom(n = n, n.test = 1000, t = t, mod = "probit")
...
for(b in 1:nreps){
  ...
  # generate data from the semirandom SCM
  s <- generate.samples.semirandom(n = n, n.test = 1000, t = t, mod = "bump")
