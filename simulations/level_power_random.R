...
for(b in 1:nreps){
  ...
  # generate data from the semirandom SCM
  s <- generate.samples.random(n = n, n.test = 1000, d = d, max.pa = max.pa, num.int = num.int, t = t, mod = "gam")
...
save(points.mod1, points.mod2, points.mod3, points.mod4, file = "level_power_random.rdata")
...
ggsave(filename = "level_power_random.pdf", width = 7, height = 7.5)
